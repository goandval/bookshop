...
// CreateIfNotExists provides a mock function with given fields: ctx, user
func (_m *UserRepository) CreateIfNotExists(ctx context.Context, user *domain.User) error {
